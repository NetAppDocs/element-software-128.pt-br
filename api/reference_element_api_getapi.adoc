...
summary: Você pode usar o método GetAPI para obter uma lista de todos os métodos de API e endpoints de API suportados que podem ser usados no sistema. 
---
= GetAPI
:allow-uri-read: 
:icons: font
...
[role="lead"]
Você pode usar o `GetAPI` Método para obter uma lista de todos os métodos da API e endpoints da API suportados que podem ser usados no sistema.
...
<versão>
 a| 
Uma lista de todos os métodos de API suportados para esta versão do software, onde <versão> é a versão atual do software que este sistema está executando.
 a| 
matriz de strings
...
versões suportadas
 a| 
Lista de todos os endpoints da API suportados pelo sistema.
 a| 
matriz de strings
