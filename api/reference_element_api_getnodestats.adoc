...
[role="lead"]
Você pode usar o `GetNodeStats` Método para recuperar as medições de atividade de alto nível para um único nó.
...
ID do nó
 a| 
Especifica o ID do nó para o qual as estatísticas serão retornadas.
 a| 
inteiro
 a| 
Nenhum
