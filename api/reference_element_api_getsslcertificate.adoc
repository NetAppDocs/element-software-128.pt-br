...
summary: Você pode usar o método GetSSLCertificate para recuperar o certificado SSL que está atualmente ativo nos nós de armazenamento do cluster. 
---
...
[role="lead"]
Você pode usar o `GetSSLCertificate` Método para recuperar o certificado SSL que está atualmente ativo nos nós de armazenamento do cluster.
