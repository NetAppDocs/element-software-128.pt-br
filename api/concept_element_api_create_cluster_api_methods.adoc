...
* xref:reference_element_api_checkproposedcluster.adoc[VerificarClusterProposto]
* xref:reference_element_api_createcluster.adoc[CriarCluster]
* xref:reference_element_api_getbootstrapconfig.adoc[Obter configuração do Bootstrap]
