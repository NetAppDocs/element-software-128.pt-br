...
summary: O método TestHardwareConfig retorna uma resposta semelhante ao exemplo a seguir. 
---
= TestHardwareConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
O `TestHardwareConfig` O método retorna uma resposta semelhante ao exemplo a seguir.
