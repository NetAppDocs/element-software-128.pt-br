...
summary: 'Você pode usar o método TestLocalConnectivity para pingar o endereço IP do cluster (CIP) de cada nó em um cluster ativo.' 
---
...
[role="lead"]
Você pode usar o `TestLocalConnectivity` Método para pingar o endereço IP do cluster (CIP) de cada nó em um cluster ativo.
...
detalhes
 a| 
Tempos de resposta de ping individuais para cada nó no cluster local ativo.
 a| 
objeto JSON
