...
summary: Você pode usar a autenticação baseada em sessão para gerenciar sessões de usuário. 
---
...
* xref:reference_element_api_listauthsessionbyusername.adoc[Listar sessões de autenticação por nome de usuário]
