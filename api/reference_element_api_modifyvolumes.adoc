...
summary: Você pode usar o método ModifyVolumes para configurar até 500 volumes existentes de uma só vez.  As alterações entram em vigor imediatamente.  Se ModifyVolumes falhar ao modificar algum dos volumes especificados, nenhum dos volumes especificados será alterado. 
---
= Modificar volumes
:allow-uri-read: 
:icons: font
