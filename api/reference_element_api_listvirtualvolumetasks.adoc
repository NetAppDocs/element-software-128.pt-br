...
summary: Você pode usar o método ListVirtualVolumeTasks para obter uma lista das tarefas de volume virtual no sistema. 
---
= ListarTarefas do Volume Virtual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
| Nome | Descrição | Tipo | Valor padrão | Obrigatório 
 ...
 a| 
IDs de tarefas de volume virtual
 a| 
Uma lista de IDs de tarefas de volume virtual para as quais recuperar informações.  Se você omitir esse parâmetro, o método retornará informações sobre todas as tarefas de volume virtual.
 a| 
matriz UUID
 a| 
Nenhum
...
Uma lista de objetos que descrevem as tarefas de volume virtual no cluster.
 a| 
xref:reference_element_api_task_virtual_volumes.adoc[tarefa]variedade
