...
summary: Você pode usar o método ListNodeStats para visualizar as medições de atividade de alto nível para todos os nós de armazenamento em um cluster de armazenamento. 
---
= ListNodeStats
:allow-uri-read: 
:icons: font
...
[role="lead"]
Você pode usar o `ListNodeStats` Método para visualizar as medições de atividade de alto nível para todos os nós de armazenamento em um cluster de armazenamento.
...
Estatísticas do nó
 a| 
Informações sobre a atividade do nó de armazenamento.
 a| 
