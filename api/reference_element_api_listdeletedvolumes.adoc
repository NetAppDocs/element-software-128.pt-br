...
summary: Você pode usar o método ListDeletedVolumes para recuperar a lista de volumes que foram marcados para exclusão e removidos do sistema. 
---
...
[role="lead"]
Você pode usar o `ListDeletedVolumes` Método para recuperar a lista de volumes que foram marcados para exclusão e removidos do sistema.
