...
summary: O método GetConfig retorna uma resposta semelhante ao exemplo a seguir.  Devido ao seu tamanho, a resposta contém informações apenas para um nó do cluster. 
---
= GetConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
O `GetConfig` O método retorna uma resposta semelhante ao exemplo a seguir.  Devido ao seu tamanho, a resposta contém informações apenas para um nó do cluster.
