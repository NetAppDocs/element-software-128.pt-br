...
summary: Você pode usar o método ListActivePairedVolumes para listar todos os volumes ativos emparelhados com um determinado volume.  Este método retorna informações sobre volumes com emparelhamentos ativos e pendentes. 
---
...
[role="lead"]
Você pode usar o `ListActivePairedVolumes` Método para listar todos os volumes ativos associados a um volume.  Este método retorna informações sobre volumes com emparelhamentos ativos e pendentes.
...
volumes
 a| 
Informações sobre o volume dos pares de volumes.
 a| 
