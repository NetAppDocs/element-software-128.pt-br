...
summary: O método GetNodeHardwareInfo para nós Fibre Channel retorna uma resposta semelhante ao exemplo a seguir. 
---
= GetNodeHardwareInfo (saída para nós Fibre Channel)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
O `GetNodeHardwareInfo` O método para nós Fibre Channel retorna uma resposta semelhante ao exemplo a seguir.
