...
summary: O método GetNetworkConfig retorna uma resposta semelhante ao exemplo a seguir. 
---
= GetNetworkConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
O `GetNetworkConfig` O método retorna uma resposta semelhante ao exemplo a seguir.
