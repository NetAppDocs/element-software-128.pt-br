...
Este método de API destina-se ao uso em nós individuais; um nome de usuário e uma senha são necessários para acessar nós Fibre Channel individuais.  Quando utilizado no cluster, todas as interfaces Fibre Channel são listadas.
