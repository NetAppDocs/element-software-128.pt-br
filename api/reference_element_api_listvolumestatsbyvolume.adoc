...
summary: Você pode usar o método ListVolumeStatsByVolume para listar as medições de atividade de alto nível para cada volume, por volume.  Os valores são cumulativos desde a criação do volume. 
---
...
[role="lead"]
Você pode usar o `ListVolumeStatsByVolume` Método para listar as medições de atividade de alto nível para cada volume, por volume.  Os valores são cumulativos desde a criação do volume.
