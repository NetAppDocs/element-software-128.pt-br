...
[role="lead"]
Você pode usar o `ListAllNodes` Método para listar os nós ativos e pendentes no cluster.
...
nós
 a| 
Lista de objetos que descrevem os nós ativos no cluster.
 a| 
...
nósativospendentes
 a| 
Lista de objetos que descrevem os nós ativos pendentes do cluster.
 a| 
...
nós pendentes
 a| 
Lista de objetos que descrevem os nós pendentes do cluster.
 a| 
