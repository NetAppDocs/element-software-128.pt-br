...
summary: Você pode usar o método SetSSLCertificate para definir um certificado SSL de usuário e uma chave privada para os nós de armazenamento no cluster. 
---
...
[role="lead"]
Você pode usar o `SetSSLCertificate` Método para configurar um certificado SSL de usuário e uma chave privada para os nós de armazenamento no cluster.
