...
summary: O método GetNvramInfo retorna uma resposta semelhante ao exemplo a seguir. 
---
= GetNvramInfo
:allow-uri-read: 
:icons: font
...
[role="lead"]
O `GetNvramInfo` O método retorna uma resposta semelhante ao exemplo a seguir.
