...
summary: O método ListActiveNodes retorna uma resposta semelhante ao exemplo a seguir. 
---
= Listar nós ativos
:allow-uri-read: 
:icons: font
...
[role="lead"]
O `ListActiveNodes` O método retorna uma resposta semelhante ao exemplo a seguir.
