...
summary: O método GetClusterHardwareInfo retorna uma resposta semelhante ao exemplo a seguir. 
---
...
[role="lead"]
O `GetClusterHardwareInfo` O método retorna uma resposta semelhante ao exemplo a seguir.
