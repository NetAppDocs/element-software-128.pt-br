...
summary: Você pode usar o comando ListSchedules para obter informações sobre todos os snapshots agendados que foram criados. 
---
= Lista de horários
:allow-uri-read: 
:icons: font
...
[role="lead"]
Você pode usar `ListSchedules` Para obter informações sobre todos os snapshots agendados que foram criados.
...
horários
 a| 
Lista dos agendamentos atualmente em execução no cluster.
 a| 
