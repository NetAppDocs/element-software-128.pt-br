...
summary: O método GetNodeHardwareInfo para iSCSI retorna uma resposta semelhante ao exemplo a seguir. 
---
= GetNodeHardwareInfo (saída para iSCSI)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
O `GetNodeHardwareInfo` O método para iSCSI retorna uma resposta semelhante ao exemplo a seguir.
