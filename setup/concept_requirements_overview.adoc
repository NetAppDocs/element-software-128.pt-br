...
sidebar: sidebar 
keywords:  
summary: Antes de começar, você deve revisar os pré-requisitos. 
---
= Requisitos
:allow-uri-read: 
:icons: font
...
[role="lead"]
Antes de começar, você deve revisar os pré-requisitos para implantar o software NetApp Element , incluindo os requisitos de rede e de portas.

* link:../storage/concept_prereq_networking.html["Requisitos de rede"]
* link:../storage/concept_prereq_switch_configuration_for_solidfire_clusters.html["Configuração do interruptor"]
