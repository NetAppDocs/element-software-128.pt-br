...
summary: Aprenda como configurar o sistema de armazenamento para o seu ambiente. 
---
...
[role="lead"]
Aprenda como configurar o sistema de armazenamento para o seu ambiente.

* xref:concept_setup_overview.adoc[Configurar armazenamento]
+
** xref:task_setup_cluster_with_storage_nodes.adoc[Configure um cluster com nós de armazenamento.]
+
*** xref:concept_setup_configure_a_storage_node.adoc[Configure um nó de armazenamento]
*** xref:task_setup_create_a_storage_cluster.adoc[Criar um cluster de armazenamento]
...
** xref:task_setup_cluster_with_fibre_channel_nodes.adoc[Configure um cluster com nós Fibre Channel.]entradas:
+
*** xref:concept_setup_fc_configure_a_fibre_channel_node.adoc[Configure um nó Fibre Channel.]
...
** xref:concept_setup_whats_next.adoc[O que vem a seguir?]
