...
[role="lead"]
Após configurar o software Element, você gerencia o armazenamento realizando algumas das seguintes opções:
...
* link:../storage/concept_system_monitoring_and_troubleshooting.html["Solucione problemas do seu sistema"]
