...
---
= Configurando um cluster com nós Fibre Channel
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Passos
. link:../setup/concept_setup_fc_configure_a_fibre_channel_node.html["Configure um nó Fibre Channel."]
. link:../setup/task_setup_fc_create_a_new_cluster_with_fibre_channel_nodes.html["Crie um novo cluster com nós Fibre Channel."]
